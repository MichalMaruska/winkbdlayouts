...
static VK_TO_WCHARS4 vk_to_wchar4[] = {
    ...
    // CAPLOK -> cap
    // KANALOK ?
    {'Q',           CAPLOK, {L'q',  L'Q', L'!', L'!'}},
    {'W',           CAPLOK, {L'w',  L'W', L'{', L'\''}},
    {'E',           CAPLOK, {L'e',  L'E', L'}', L'|'}},
    {'R',           CAPLOK, {L'r',  L'R', L'}', L'^'}},
    {'T',           CAPLOK, {L't',  L'T', L'@', L'`'}},

    {'A',           CAPLOK, {L'a',  L'A', L'?', L'?'}},
    {'S',           CAPLOK, {L's',  L'S', L'(', L'#'}},
    {'D',           CAPLOK, {L'd',  L'D', L')', L'*'}},
    {'F',           CAPLOK, {L'f',  L'F', L'/', L'/'}},
    {'G',           CAPLOK, {L'g',  L'G', L'_', L'_'}},

    {'Z',           CAPLOK, {L'z',  L'Z', L',', L','}},
    {'X',           CAPLOK, {L'x',  L'X', L'[', L'['}},
    {'C',           CAPLOK, {L'c',  L'C', L']', L':'}},
    {'V',           CAPLOK, {L'v',  L'V', L']', L'\\'}},
    {'B',           CAPLOK, {L'b',  L'B', L'\'', L'+'}},
